...
const Attendance = () => {
  ...
  const batches = ['JEE Main - Physics', 'NEET - Chemistry', 'JEE Advanced - Maths', 'NEET - Biology'];
  ...
  const recentAttendance = [
    ...
    { date: '2024-01-13', batch: 'JEE Advanced - Maths', present: 26, total: 28 },
  ...
  const markAll = (present: boolean) => {
    const newData: {[key: number]: boolean} = {};
              ...
              {students.map((student) => (
                <div key={student.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-sm text-gray-500">({student.rollNo})</span>
                  </div>
            ...
            <div className="space-y-4">
              {recentAttendance.map((record, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    <h4 className="font-medium text-gray-900">{record.batch}</h4>
